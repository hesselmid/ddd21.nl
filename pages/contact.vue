<template>
  <main>
    <div class="mx-auto max-w-[375px] md:w-[768px] md:max-w-none xl:w-[1280px]">
      <h1
        class="mt-[27px] ml-[44px] text-[40px] leading-[48px] md:mt-[69px] md:ml-[77px] md:text-[45px] md:leading-[54px] xl:mt-[129px] xl:ml-[101px] xl:text-[50px] xl:leading-[61px]"
      >
        Contact
      </h1>
      <div
      ...
      >
        ...
        <p
          class="mt-[19px] text-[16x] leading-[19px] md:mt-[29px] md:text-[22px] md:leading-[27px] xl;mt-[30px] xl:text-[25px] xl:leading-[30px]"
        >
          connect with us on
          <a
            class="underline"
        ...
        <p
          class="mt-[19px] text-[16x] leading-[19px] md:text-[22px] md:leading-[27px] xl:mt-[30px] xl:text-[25px] xl:leading-[30px]"
        >
